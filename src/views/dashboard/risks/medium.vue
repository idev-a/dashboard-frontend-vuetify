<template>
  ...
  >
    ...
    >
      ...
      <v-card-text>
        <span>
          Medium risk findings mean the impact and likelihood of a security event is probable. Reputation and financial  damage is moderate. These findings should have a resolution or control.
        </span>
      </v-card-text>
    </v-card>
    <v-card
